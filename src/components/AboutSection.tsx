    ...
    <section id="about" className="py-20 md:py-32 relative">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          {/* Summary Card */}
          <div className={`glass hover-card rounded-2xl p-6 md:p-8 animate-on-scroll ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: '0.2s' }}>
            ...
            <p className="text-muted-foreground leading-relaxed font-body">
              Driven and enthusiastic AI & Data Science developer with hands-on experience in
              machine learning, deep learning, data analysis, cloud computing, and modern web technologies.
              Passionate about building intelligent, scalable, real-world solutions and staying ahead of
              cutting-edge AI trends.
            </p>
          </div>

          {/* Education Card */}
          <div className={`glass hover-card rounded-2xl p-6 md:p-8 animate-on-scroll ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: '0.3s' }}>
            <div className="flex items-center gap-3 mb-6">
          ...
          {/* Languages Card */}
          <div className={`glass hover-card rounded-2xl p-6 md:p-8 animate-on-scroll ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: '0.4s' }}>
            <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              {languages.map((lang) => (
                <span
                  key={lang}
                  className="px-4 py-2 rounded-full bg-neon-green/10 text-neon-green font-mono text-sm border border-neon-green/30"
                >
                  {lang}
                </span>
              ))}
          ...
          {/* Interests Card */}
          <div className={`glass hover-card rounded-2xl p-6 md:p-8 animate-on-scroll ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: '0.5s' }}>
            <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              {interests.map((interest) => (
                <span
                  key={interest}
                  className="px-4 py-2 rounded-full bg-neon-pink/10 text-neon-pink font-mono text-sm border border-neon-pink/30"
                >
                  {interest}
                </span>
              ))}
